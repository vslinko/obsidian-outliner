...
export class Settings {
  ...
  get enterOutdentsEmptyListItem() {
    return this.values.betterEnterOutdent;
  }

  set enterOutdentsEmptyListItem(value: boolean) {
    this.set("betterEnterOutdent", value);
  }
